            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <form id="validation2" action="{{ route('updateEvent', ['id' => $records->id]) }}"
                            ...
                            <div class="modal-body clearfix" style="max-height: 800px; overflow-y: auto;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content" class="validate[required] form-control " rows="5">{{ old('content', $records->content ?? '') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="from_date"
                                            ...
                                            value="{{ old('from_date', $records->from_date) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="to_date"
                                            ...
                                            placeholder="DD-MM-YYYY"
                                            value="{{ old('to_date', $records->to_date) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="time" name="start_time" class="form-control" id="start_time"
                                            value="{{ old('start_time', $records->start_time ? date('H:i', strtotime($records->start_time)) : '') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="time" name="to_time" class="form-control" id="to_time"
                                            value="{{ old('to_time', $records->to_time ? date('H:i', strtotime($records->to_time)) : '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="location" class="validate[required] form-control"
                                            value="{{ old('location', $records->location) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="contact_detail" class="form-control"
                                            value="{{ old('contact_detail', $records->contact_detail ?? '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="url" name="website_url" class="form-control"
                                            placeholder="https://example.com" value="{{ old('website_url', $records->website_url ?? '') }}">
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="url" name="facebook" class="form-control"
                                                    ...
                                                    value="{{ old('facebook', $records->facebook ?? '') }}">
                                            </div>
                                            <div class="col-sm-4">
                                                <label>Instagram</label>
                                                <input type="url" name="instagram" class="form-control"
                                                    placeholder="https://instagram.com/..."
                                                    value="{{ old('instagram', $records->instagram ?? '') }}">
                                            </div>
                                            <div class="col-sm-4">
                                                <label>LinkedIn</label>
                                                <input type="url" name="linkedin" class="form-control"
                                                    placeholder="https://linkedin.com/..."
                                                    value="{{ old('linkedin', $records->linkedin ?? '') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        @if ($records->image)
                                            <img src="{{ asset('storage/event/' . $records->image) }}" alt=""
                                                id="imagePreview" style="max-width: 200px; margin-top: 10px;">
                                        @else
                                                ...
                                                <div
                                                    ...
                                                    @foreach ($records->galleries as $gallery)
                                                        <div style="position: relative; width: 150px;">
                                                            <img src="{{ asset('storage/event/gallery/' . $gallery->image) }}"
                                                                alt=""
                                                                style="width: 100%; height: 150px; object-fit: cover; border: 1px solid #ddd; border-radius: 4px;">
                                                            <button type="button"
                                                                class="btn btn-danger btn-xs delete-gallery-image"
                                                                data-id="{{ $gallery->id }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="meta_title" class="validate[required] form-control"
                                            value="{{ old('meta_title', $records->meta_title) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="meta_keyword" class="validate[required] form-control"
                                            value="{{ old('meta_keyword', $records->meta_keyword) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="title" class="col-sm-3 control-label">Meta Description</label>
                                    <div class="col-sm-9">
                                        <textarea name="meta_description" class="form-control" rows="5">{{ old('meta_description', $records->meta_description) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="canonical" class="validate[required] form-control"
                                            value="{{ old('canonical', $records->canonical) }}">
                                    </div>
                                </div>
                            </div>
