<form id="validation2" action="{{route('saveAbout')}}" class="form-horizontal" enctype="multipart/form-data" method="post">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea type="text" name="content" class="form-control summernote" rows="10" ></textarea>
            </div>
        </div>
        <div class="form-group">
