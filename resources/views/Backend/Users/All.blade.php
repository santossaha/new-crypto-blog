    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                @permission('add-user')
                    <div class="box-tools">
                        <a href="javascript:void(0);" class="btn btn-primary btn-flat" data-act="ajax-modal" data-title="Add User" data-append-id="AjaxModelContent" data-action-url="{{route("addUser")}}">
