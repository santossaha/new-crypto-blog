<form id="validation2" action="{{route('saveBanner')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="file" name="image[]" id="image"  class="validate[required] form-control" multiple>
