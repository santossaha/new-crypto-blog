<form id="validation2" action="{{route('updateBanner',$records->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="url" id="url" class="form-control" placeholder="Enter banner link (optional)" value="{{ old('url', $records->url ?? '') }}">
            </div>
        </div>
