<form id="validation2" action="{{route('updateCountry',['id'=>$ID])}}" class="form-horizontal" method="post">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="country_code" class="validate[required,custom[onlyNumberSp]] form-control" value="{{$record->country_code}}">
            </div>
        </div>
    </div>
