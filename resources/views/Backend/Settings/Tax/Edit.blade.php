<form id="validation2" action="{{route('updateTax',['id'=>$ID])}}" class="form-horizontal" method="post">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="name" class="validate[required] form-control" id="RoleName" value="{{$record->name}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="tax" class="validate[required, custom[number],max[99],min[1]] form-control" value="{{$record->tax}}">
            </div>
        </div>
    </div>
