<form id="validation2" action="{{route('updateAddsImage',$records->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="date" name="expire_date" id="expire_date"  class="validate[required] form-control" value="{{$records->expire_date}}">
