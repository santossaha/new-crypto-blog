                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Update ICO: {{ $records->name }}</h3>
                        </div>
                        ...
                        <form id="validation2" action="{{ route('updateICO', ['id' => $records->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="name" class="validate[required] form-control" value="{{ old('name', $records->name) }}" placeholder="e.g., Automated Meta Finance ($AMFI)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="launchpad" class="form-control" value="{{ old('launchpad', $records->launchpad) }}" placeholder="e.g., On Website, Binance Launchpad">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select name="ico_status" class="form-control select2" data-placeholder="Select Status">
                                                    ...
                                                    @foreach($icoStatuses as $key => $value)
                                                        <option value="{{ $key }}" {{ old('ico_status', $records->ico_status) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if ($records->image)
                                                    <img src="{{ getFullPath('ico', $records->image) }}" alt="{{ $records->name }}" id="imagePreview" style="max-width: 150px; margin-top: 10px;">
                                                @else
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" name="total_supply_qty" class="form-control" value="{{ old('total_supply_qty', $records->total_supply_qty) }}" placeholder="e.g., 777000000.00">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" name="tokens_for_sale" class="form-control" value="{{ old('tokens_for_sale', $records->tokens_for_sale) }}" placeholder="e.g., 233100000.00">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" name="supply_percentage" class="form-control" value="{{ old('supply_percentage', $records->supply_percentage) }}" placeholder="e.g., 30.00" min="0" max="100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" step="0.000001" name="ico_price" class="form-control" value="{{ old('ico_price', $records->ico_price) }}" placeholder="e.g., 0.03">
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="text" name="ico_price_currency" class="form-control" value="{{ old('ico_price_currency', $records->ico_price_currency ?? 'USDT') }}" placeholder="Currency (USDT)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="one_usdt_value" class="form-control" value="{{ old('one_usdt_value', $records->one_usdt_value) }}" placeholder="e.g., 33.33 AMFI or TBA">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" name="fundraising_goal" class="form-control" value="{{ old('fundraising_goal', $records->fundraising_goal) }}" placeholder="e.g., 6993000">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="soft_cap" class="form-control" value="{{ old('soft_cap', $records->soft_cap) }}" placeholder="e.g., $500,000 or TBA">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="hard_cap" class="form-control" value="{{ old('hard_cap', $records->hard_cap) }}" placeholder="e.g., $10,000,000 or TBA">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="personal_cap" class="form-control" value="{{ old('personal_cap', $records->personal_cap) }}" placeholder="e.g., $10,000 or TBA">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="url" name="buy_link" class="form-control" value="{{ old('buy_link', $records->buy_link) }}" placeholder="https://...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="contract_address" class="form-control" value="{{ old('contract_address', $records->contract_address) }}" placeholder="0x...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="url" name="website_url" class="form-control" value="{{ old('website_url', $records->website_url) }}" placeholder="https://...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="url" name="whitepaper_url" class="form-control" value="{{ old('whitepaper_url', $records->whitepaper_url) }}" placeholder="https://...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label>Twitter</label>
                                                        <input type="url" name="twitter_url" class="form-control" placeholder="https://twitter.com/..." value="{{ old('twitter_url', $records->twitter_url) }}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Telegram</label>
                                                        <input type="url" name="telegram_url" class="form-control" placeholder="https://t.me/..." value="{{ old('telegram_url', $records->telegram_url) }}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Discord</label>
                                                        <input type="url" name="discord_url" class="form-control" placeholder="https://discord.gg/..." value="{{ old('discord_url', $records->discord_url) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="short_description" class="form-control" rows="3" placeholder="Brief description of the ICO project">{{ old('short_description', $records->short_description) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="description" class="form-control summernote" rows="5">{{ old('description', $records->description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $records->meta_title) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="meta_keyword" class="form-control" value="{{ old('meta_keyword', $records->meta_keyword) }}" placeholder="keyword1, keyword2, keyword3">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="meta_description" class="form-control" rows="3">{{ old('meta_description', $records->meta_description) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="canonical" class="form-control" value="{{ old('canonical', $records->canonical) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-flat"><span class="fa fa-check-circle"></span> Update ICO</button>
                            </div>
                        </form>
