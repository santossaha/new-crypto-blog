                                ...
                                <tr><td align="center">
                                        <a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; float:left; width:100%; padding:20px;text-align:center; font-size: 13px;">
                                            <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
                                                <img src="{{ url('/') }}/uploads/generalSetting/{{$generalDetails->site_logo}}" width="250" alt="{{$companyDetails->company_name}}" border="0"  /></font></a>
                                    </td>
                                    <td align="right">
                                        <!--[endif]--><!--
                                        ...
                                        <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        Dear {{$name}},<br/>
                                                        Welcome to {{$companyDetails->company_name}}!<br/>
                                                        Your password link has been generated.
                                                        <br/>
                                                        <br/>
                                                        <br/>
                                                        <br/>
                                                        <a href="{{$reset_link}}" style="margin: 20px; padding: 8px;
                                                                        border-radius: 0;
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <div style="line-height: 24px;">
                                                            This is auto generate mail from system please do not reply.
                                                        </div>
