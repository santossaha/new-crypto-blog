    ...
    public function allEventsDatabase(){
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('action', function ($data) {
                ...
                $edit = '<a class="label label-primary" data-title="Edit Event" data-act="ajax-modal" data-append-id="AjaxModelContent" data-action-url="'.$url_update.'" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a>';
